    ...
    <div>
        <el-card class="box-card">
            <el-form :model="ruleForm" :rules="rules" ref="ruleForm" label-width="100px" class="demo-ruleForm">
                <el-form-item label="超级用户账号" prop="administrator">
                    <el-input type="text" @blur="validateAID" v-model="ruleForm.administrator"></el-input><span  class="validateInfo">{{validateInfo}}</span>
                </el-form-item>
                ...
                <el-form-item label="权限等级" prop="aPermission">
                    <el-input type="text" v-model="ruleForm.aPermission" :disabled="true"></el-input>
                </el-form-item>
                ...
                this.$refs[formName].validate((valid) => {
                    if (valid) {
                        axios({
                            ...
                            url: '/admin_modify',
                            data: this.$qs.stringify({administrator: this.ruleForm.administrator,
                                password: this.ruleForm.password,preAdmin:JSON.parse(localStorage.getItem('loginUser')).administrator})
                        }).then(res=>{
